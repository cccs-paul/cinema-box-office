/*
 * myRC - Travel Money Allocation DTO
...
/**
 * Data Transfer Object for TravelMoneyAllocation.
 *
 * @author myRC Team
 * @version 1.0.0
 * @since 2026-02-16
 */
public class TravelMoneyAllocationDTO {
  ...
  public TravelMoneyAllocationDTO() {}

  public static TravelMoneyAllocationDTO fromEntity(TravelMoneyAllocation entity) {
    TravelMoneyAllocationDTO dto = new TravelMoneyAllocationDTO();
